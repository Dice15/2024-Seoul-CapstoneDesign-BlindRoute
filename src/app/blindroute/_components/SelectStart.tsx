...
interface SelectStartProps {
    ...
    setStart: React.Dispatch<React.SetStateAction<Station | null>>
}


export default function SelectStart({ locations, setStep, setStart }: SelectStartProps) {
    // hook
    ...
    const handleInitSpeak = useCallback((swiper: SwiperClass) => {
        ...
        const guide = "출발 정류장을 선택하세요. 위아래 스와이프로 정류장을 선택할 수 있습니다.";
