import { IGetTransitRoutesResponse } from '@/types/externalApi/tmap/IGetTransitRoutesResponse';
...
export class TransitRoutesService {
    ...
    private static getTransitRoutesByTMapAPI(startX: string, startY: string, destinationX: string, destinationY: string): Promise<AxiosResponse<IGetTransitRoutesResponse, any>> {
        return axios.post<IGetTransitRoutesResponse>(
    ...
    private static getTransitRoutesByStaticData(): IGetTransitRoutesResponse {
        return {
            "metaData": {
                "requestParameters": {
                    "busCount": 4,
